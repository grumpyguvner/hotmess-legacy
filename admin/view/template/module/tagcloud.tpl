			...
			<tbody id="module-row<?php echo $module_row; ?>">
				<tr>
                    <td class="left"><?php foreach ($languages as $language) { ?>
        				<input name="tagcloud_module[<?php echo $module_row; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($module['title'][$language['language_id']]) ? $module['title'][$language['language_id']] : ''; ?>" />
...
function addModule() {	
   ...
   html += '    <td class="left">';
	...
	html += '      <input name="tagcloud_module[' + module_row + '][title][<?php echo $language['language_id']; ?>]" />';
