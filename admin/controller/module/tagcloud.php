...
class ControllerModuleTagCloud extends Controller {
	...
	public function install() 
	{
		...
		0 => array ( 'limit' => 20, 'title' => $array_description0, 'font_weight' => 'normal','layout_id' => $this->getIdLayout("product"), 'position' => 'column_left', 'min_font_size' => 9, 'max_font_size' => 25, 'status' => 1, 'sort_order' => 4),
        1 => array ( 'limit' => 20, 'title' => $array_description1, 'font_weight' => 'normal','layout_id' => $this->getIdLayout("category"), 'position' => 'column_left', 'min_font_size' => 9, 'max_font_size' => 25, 'status' => 1, 'sort_order' => 4),
        2 => array ( 'limit' => 20, 'title' => $array_description2, 'font_weight' => 'normal','layout_id' => $this->getIdLayout("manufacturer"), 'position' => 'column_left', 'min_font_size' => 9, 'max_font_size' => 25, 'status' => 1, 'sort_order' => 4)
		));
		
		$this->model_setting_setting->editSetting('tagcloud', $tagcloud);		
	}
}
?>